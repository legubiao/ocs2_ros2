    ...
    ld = launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument(
            ...
            default_value=get_package_share_directory(
                'ocs2_robotic_assets') + '/resources/mobile_manipulator/mabi_mobile/urdf/mabi_mobile.urdf'
        ),
        launch.actions.DeclareLaunchArgument(
            name='taskFile',
            default_value=get_package_share_directory(
                'ocs2_mobile_manipulator') + '/config/mabi_mobile/task.info'
        ),
        launch.actions.DeclareLaunchArgument(
            name='libFolder',
            default_value=_ocs2_codegen_dir('ocs2_mobile_manipulator', 'mabi_mobile')
        ),
