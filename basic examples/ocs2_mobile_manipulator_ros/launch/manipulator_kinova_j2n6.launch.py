    ...
    ld = launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument(
            ...
            default_value=get_package_share_directory(
                'ocs2_robotic_assets') + '/resources/mobile_manipulator/kinova/urdf/j2n6s300.urdf'
        ),
        launch.actions.DeclareLaunchArgument(
            name='taskFile',
            default_value=get_package_share_directory(
                'ocs2_mobile_manipulator') + '/config/kinova/task_j2n6.info'
        ),
        launch.actions.DeclareLaunchArgument(
            name='libFolder',
            default_value=_ocs2_codegen_dir('ocs2_mobile_manipulator', 'kinova/j2n6')
        ),
