    ...
    ld = launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument(
            ...
            default_value=get_package_share_directory(
                'ocs2_robotic_assets') + '/resources/mobile_manipulator/pr2/urdf/pr2.urdf'
        ),
        launch.actions.DeclareLaunchArgument(
            name='taskFile',
            default_value=get_package_share_directory(
                'ocs2_mobile_manipulator') + '/config/pr2/task.info'
        ),
        launch.actions.DeclareLaunchArgument(
            name='libFolder',
            default_value=_ocs2_codegen_dir('ocs2_mobile_manipulator', 'pr2')
        ),
