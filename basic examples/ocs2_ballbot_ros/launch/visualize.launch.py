...
def generate_launch_description():
    rviz_config_file = get_package_share_directory('ocs2_ballbot_ros') + "/rviz/ballbot.rviz"
    urdf_dir = get_package_share_directory("ocs2_robotic_assets")
    urdf_model_path = os.path.join(urdf_dir, "resources/ballbot/urdf", "ballbot.urdf")
